...
\paragraph{Floquet eigenvalue derivation (v0.7).}
...
\begin{equation}\label{eq:tau}
  \frac{m_\tau}{m_e} = \frac{\Phithree - n}{\lambda} + p + \frac{1}{p-1}
  = \frac{13909}{4} = 3477.25
\end{equation}
...
ratio $3477.42(18)$. Both formulas within ${\sim}1\,\sigma$.

\paragraph{Tau unification (v0.7).}
A second formula $m_\tau/m_e = X^2 - 1/\lambda + \Phithree/p^2 = 86931/25
= 3477.24$ also matches. The two formulas differ by \emph{exactly}
$1/(2p)^2 = 1/100$---the square of the muon zero-point coupling energy
$1/(2p)$. They are unified as
\begin{equation}\label{eq:tau-unified}
  \frac{m_\tau}{m_e} = X^2 - \frac{1}{\lambda} + \frac{\Phithree}{p^2}
  + \delta, \qquad \delta \in \{0,\; 1/(2p)^2\}.
\end{equation}
The separation ($2.9\ppm$) requires $35\times$ the current precision
($50.6\ppm$ at HFLAV 2025) to resolve experimentally. The $\delta$
correction connects the tau to the muon through the coupling quantum
hierarchy (verification: \texttt{cuft-tau-unification.py}).
